...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/library-import/naming", post(books::naming_save))
        .route("/library-import/organize", post(books::organize_apply))
        ...
        .route("/settings/indexers/prowlarr-import", post(indexer::prowlarr_import))
